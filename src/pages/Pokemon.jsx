          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <p className="subtitle">
                Search for your favourite Pokémon using its name or its National Pokédex number!
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container">
        <div className="row">
            <div className="col-md-6">
              ...
              <input className="form-control form-control-lg" id="frm-search" type="text" placeholder="Pikachu or 61" aria-label="Name or Number"/>
            </div>
          </div>
      </div>
    </div>
        ...
        <div className="row">
          { pokemon.results &&
            ...
            <div className="col-sm crd-col" key={ index }>
              <div className="card poke-card" style={{ width: "18rem", height: "20rem" }} onClick={() => handleClick(item.name)}>
                <div className="img-container">
                  <img src = {`https://img.pokemondb.net/artwork/large/${item.name}.jpg`} className="card-img-top poke-img" alt="..." />
                </div>
